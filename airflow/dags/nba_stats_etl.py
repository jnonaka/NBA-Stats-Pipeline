...
with DAG(
    ...
    extract_playerstat_data_to_csv = PythonOperator(
        task_id = 'extract_playerstat_data_to_csv',
    ...
    extract_game_data_to_csv >> playerstats_api_call >> extract_playerstat_data_to_csv >> format_to_parquet_playerstats \
